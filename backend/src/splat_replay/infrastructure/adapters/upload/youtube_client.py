...
from splat_replay.infrastructure import filesystem as paths
...
class YouTubeClient(UploadPort, AuthenticatedClientPort):
    ...
    def _ensure_credentials_file(self) -> None:
        ...
        self.logger.error("Client secrets not found", message=message)
    ...
    def upload_video(
        ...
        try:
            ...
            self.logger.error("Upload failed", error=str(e))
            return None
        finally:
            if media_file:
                del media_file
    ...
    def upload_thumbnail(self, video_id: str, thumb: Path) -> None:
        ...
        try:
            ...
            self.logger.error("Thumbnail upload failed", error=str(e))
        finally:
            if media_file:
                del media_file
                gc.collect()
    ...
    def upload_subtitle(
        ...
        try:
            ...
            self.logger.error("Subtitle upload failed", error=str(e))
        finally:
            if media_file:
                del media_file
                gc.collect()
    ...
    def add_to_playlist(self, video_id: str, playlist_id: str) -> None:
        ...
        try:
            ...
            self.logger.error("Add to playlist failed", error=str(e))
